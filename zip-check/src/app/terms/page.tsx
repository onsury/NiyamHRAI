    ...
    <div className="bg-[#0a0a0f] text-white min-h-screen">
      ...
      <section className="pt-32 md:pt-40 pb-24 px-4 md:px-6 lg:px-16">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight mt-4 mb-8">The basics of using NiyamHR.</h1>
          ...
          <div className="space-y-6 text-white/60 leading-relaxed">
            ...
            <p>
              NiyamHR is currently in Early Access. The Service is provided on an &ldquo;as is&rdquo; and &ldquo;as available&rdquo; basis. Features may change, and occasional service interruptions are possible. We will communicate material changes in advance where practical.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>You must be at least 18 years old to use NiyamHR</li>
            ...
            <p>NiyamHR uses large language models (Anthropic Claude) to generate mentorship responses, DNA mappings, and analyses. You acknowledge that:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>AI-generated content reflects pattern-matching against data, not professional advice</li>
              <li>NiyamHR is not a substitute for licensed HR, legal, medical, psychological, or financial advice</li>
            ...
            <p>
              NiyamHR is a startup in Early Access. As we grow, these Terms may be refined to reflect a more mature enterprise relationship. We commit to notifying you of any material changes. See our <Link href="/security" className="text-amber-500 hover:text-amber-400">Security page</Link> for our compliance roadmap.
            </p>
