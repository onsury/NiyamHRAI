        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-3 sm:space-y-4 mb-5 sm:mb-6">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Min 6 characters" required minLength={6} className="w-full p-3 sm:p-4 bg-white/5 border-2 border-white/10 rounded-xl sm:rounded-2xl text-white font-bold text-sm sm:text-base placeholder:text-white/15 focus:border-amber-500/50 transition-all outline-none" />
            </div>
          </div>
