...
export default function VerifyEmailPage() {
  ...
  const { firebaseUser, niyamUser, resendVerification, refreshUser, signOut, loading } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="max-w-lg w-full text-center relative z-10">
        ...
        <p className="text-white/30 mb-8 sm:mb-10 leading-relaxed text-sm sm:text-base px-2">Click the link in the email to verify your account. This page will automatically redirect once verified.</p>
