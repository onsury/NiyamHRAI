      ...
      <section className="pt-40 pb-24 px-6 lg:px-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-white/60 leading-relaxed">
            ...
            <p>
              NiyamAI is a product of SmartDNA Business Intelligence & Advisory (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;). This Privacy Policy explains how we collect, use, and protect personal data when you use NiyamAI (&ldquo;the Service&rdquo;).
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong className="text-white">Diagnostic data:</strong> responses to the Founder DNA diagnostic, employee onboarding assessments, and behavioral trait mappings</li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Generate personalised founder DNA and employee alignment analyses</li>
            ...
            <p>
              <strong className="text-white">We do not sell your data.</strong> We do not use your reflections or organisational data to train AI models.
            </p>

            <h2 className="text-2xl font-black text-white mt-10 mb-4">3. Third-party services</h2>
            <p>
              NiyamAI uses the following third-party services:
            </p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>
              NiyamAI is operated from India. If you are accessing the Service from outside India, please note your data may be processed in countries where we or our service providers operate. We apply the same privacy protections regardless of your location.
            </p>
            ...
            <p>
              NiyamAI uses essential cookies for authentication and session management. We do not use third-party tracking cookies or advertising cookies. By using the Service, you consent to our use of essential cookies.
            </p>

            <h2 className="text-2xl font-black text-white mt-10 mb-4">9. A note on our stage</h2>
            <p>
              NiyamAI is a startup in Early Access. While we apply enterprise-grade infrastructure and security practices from day one, we are continuously building out our compliance programs. See our <Link href="/security" className="text-amber-500 hover:text-amber-400">Security page</Link> for our detailed roadmap.
            </p>
